...
class AboutIteration < EdgeCase::Koan
  ...
  # -- An Aside ------------------------------------------------------
  # Ruby 1.8 stores names as strings. 
  # Ruby 1.9 stores names as symbols. So we use a version 
  # dependent method "as_name" to convert
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # Combines all the elements in the array
  end
