...
class AboutClassMethods < EdgeCase::Koan
  ...
  def test_objects_have_methods
    fido = Dog.new
    assert fido.methods.size > _n_(1), "XXX"
  end

  def test_classes_have_methods
    assert Dog.methods.size > _n_(1), "XXX"
  end
  ...
  #   end
  #
  # Which do you prefer and why? >> The first one is more readable
  # readable there times you might prefer one over the other?
